...
@section('body')
    <section class="common_content">
        <div class="portlet-body" style="padding:25px 0 0 15px">
            <!-- BEGIN FORM-->
            <form action="{{route('category/edit')}}" method="post" id="form_horizontal" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3">上级分类：
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3">别名
                            <span class="required">  </span>
                        </label>
                        <div class="col-xs-8">
                            <input type="text" id="alias" name="alias" value="{{ $info->alias }}" data-required="1" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
