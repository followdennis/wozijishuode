...
@section('CUSTOM_SCRIPT')
    ...
    <script type="text/javascript">
        ...
        var routes = {
            list: {
                fetch : '{{route('skill_task/list')}}',
                delete : '{{route('skill_task/del')}}',
                edit:'{{ route('skill_task/edit') }}',
                change_status:'{{ route('public_skill_task/change_status') }}',
            }
        };
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue-steel">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-cogs"></i>技能任务列表 </div>

                            <div class="actions">
                                <a href="{{route('skill_task/add')}}" class="btn btn-default btn-sm">
                                    <i class="fa fa-plus"></i> 添加技能任务
                                </a>
                            </div>
                        </div>
