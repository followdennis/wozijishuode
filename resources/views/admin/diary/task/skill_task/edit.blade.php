...
@section('CUSTOM_SCRIPT')
    ...
    <script src="{{asset('js/admin/task/skill/form.js')}}" type="text/javascript"></script>
    <script>
...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- BEGIN FORM-->
            <form action="{{route('skill_task/edit')}}" method="post" id="form_horizontal" class="form-horizontal" enctype="multipart/form-data">
