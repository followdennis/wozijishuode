...
@section('CUSTOM_SCRIPT')
    ...
    <script>
        ...
        var routes = {
            list: {
                fetch : 'innerlink/list',
                edit:'{{route('innerlink/edit')}}',
                del : '{{route('innerlink/del')}}'
            }
        };
                    ...
                    <div class="portlet box red">
                        ...
                        <div class="portlet-body">
                            <form method="POST" id="search-form" class="form-inline pull-right" role="form">
                                ...
                                <div  id="set_start" class="input-group date date-picker form_date" data-date-format="yyyy-mm-dd">
                                    <input id="start_date" name="start_date"  type="text" placeholder="结束时间" class="form-control">
                                ...
                                <div id="set_end" class="input-group date date-picker form_date" data-date-format="yyyy-mm-dd">
                                    <input id="end_date" name="end_date"  type="text" placeholder="结束时间" class="form-control">
                                    <span class="input-group-btn">
                                            <button class="btn default" type="button">
                                                <i class="fa fa-calendar"></i>
                                            </button>
