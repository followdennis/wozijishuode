...
@section('body')
    ...
    <div class="portlet-body" style="padding:25px 0 0 15px">
        <!-- BEGIN FORM-->
        <form action="{{route('role/edit')}}" method="post" id="form_horizontal" class="form-horizontal" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <div class="mt-radio-list" data-error-container="#name_error">
                            <input type="text" id="name" name="name" value="{{ $info->name }}" data-required="1" class="form-control" />
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="text" name="display_name" value="{{ $info->display_name }}" data-required="1" class="form-control" />
                    </div>
                </div>
