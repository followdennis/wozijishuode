...
@section('body')
    <section class="common_content">
        <div class="portlet-body" style="padding:25px 0 0 15px">
            <!-- BEGIN FORM-->
            <form action="{{route('friend_link/edit')}}" method="post" id="form-horizontal" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <div class="mt-radio-list" data-error-container="#password">
                                <input type="text" id="link_url" name="link_url" value="{{ $data->link_url }}" data-required="1" class="form-control" />
                            </div>
                            <div id="password"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                <input type="text" id="sort" name="sort" value="{{ $data->sort }}" data-required="1" class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-9" style="height:32px;">
                            <input type="checkbox" name="is_front"  id="is_front" value="1" @if($data->is_front)checked @endif class="make-switch" data-on-text="是" data-off-text="否">
                        </div>
                    </div>
                </div>
